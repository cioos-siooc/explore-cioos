...
The z7 tiles (`tiles/tiles/7-*`, `tiles/tiles-tracks/7-*`) and
`api/trajectories_track.json` are synthetic: markers and tracks the recorded set
has none of, generated from `e2e/support/syntheticScene.js` by
`node e2e/build-synthetic-tiles.mjs`. Edit the scene and regenerate rather than
