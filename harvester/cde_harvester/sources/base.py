...
class HarvestResult:
    ...
    trajectory_footprints: DataFrame[TrajectoryFootprintSchema] = None
    ...
    def __post_init__(self):
        ...
        if self.trajectory_footprints is None:
            self.trajectory_footprints = pd.DataFrame(
    ...
    def validate(self):
        ...
        for name, schema in [
            ...
            ("trajectory_footprints", TrajectoryFootprintSchema),
