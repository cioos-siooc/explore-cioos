...
describe("GET /downloadEstimate", () => {
  ...
  it("calls getShapeQuery with doEstimate=true", async () => {
    ...
    expect(getShapeQuery).toHaveBeenCalledWith(expect.any(Object), true, false);
  });

  it("passes filter params to getShapeQuery", async () => {
    await request(app).get(
      "/downloadEstimate?datasetPKs=1,2&timeMin=2020-01-01T00:00:00Z",
    );
